...
Label(root,text="#Restaurant/Hotel Name",font="comicsanms 25 italic",fg="Red",padx=200,pady=10,).grid(row=0,column=0,columnspan=3,sticky="w")
...
def totalbill():
 ...
 #total.set((food1*10)+(food2*10))
 total.set((food1*10)+(food2*10)+(food3*15)+(food4*20)+(food5*20)+(food6*50)+(food7*30)+(food8*25)+(food9*35)+(food10*25)+(food11*25)+(food13*90)+(food14*110)+(food15*120)+(food16*120)+(food17*160)+(food19*140)+(food20*110)+(food21*130)+(food22*120)+(food23*190)+(food24*10)+(food25*15)+(food26*25)+(food27*30)+(food28*30)+(food29*35)+(food30*80)+(food31*50)+(food32*100)+(food33*120)+(food34*120)+(food35*120)+(food36*150)+(food37*160)+20)
#########################################################################################
...
#starter
foodvm=Checkbutton(root,text="Veg Manchurian Dry\t₹90",variable=var31,font=" helvetica10",command=food_vm).grid(row=11,column=0,sticky="W")
foodnvm=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_31)
foodnvm.grid(row=11,column=1,sticky="w")
foodmcd=Checkbutton(root,text="Mushroom Chilly Dry\t₹110",variable=var32,font=" helvetica10",command=food_mcd).grid(row=12,column=0,sticky="W")
foodnmcd=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_32)
foodnmcd.grid(row=12,column=1,sticky="w")
foodpcd=Checkbutton(root,text="Paneer Chilly Dry\t\t₹120",variable=var33,font=" helvetica10",command=food_pcd).grid(row=13,column=0,sticky="W")
foodnpcd=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_33)
foodnpcd.grid(row=13,column=1,sticky="w")
foodv65=Checkbutton(root,text="Veg 65 Dry\t\t₹120",variable=var34,font=" helvetica10",command=food_v65).grid(row=14,column=0,sticky="W")
foodnv65=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_34)
foodnv65.grid(row=14,column=1,sticky="w")
foodcchilly=Checkbutton(root,text="Chicken Chilly\t\t₹160",variable=var35,font=" helvetica10",command=food_cchilly).grid(row=15,column=0,sticky="W")
foodncc=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_35)
foodncc.grid(row=15,column=1,sticky="w")
# foodcmd=Checkbutton(root,text="Chicken Manchurian Dry\t₹130",variable=var36,font=" helvetica10",command=food_cmd).grid(row=16,column=0,sticky="W")
# foodnmcd=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_36)
# foodnmcd.grid(row=16,column=1,sticky="w")
foodccrispy=Checkbutton(root,text="Chicken Crispy\t\t₹140",variable=var37,font=" helvetica10",command=food_ccrispy).grid(row=17,column=0,sticky="W")
...
foodcl=Checkbutton(root,text="Chicken Lollypop\t\t₹110",variable=var38,font=" helvetica10",command=food_clolly).grid(row=18,column=0,sticky="w")
foodncl=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_38)
foodncl.grid(row=18,column=1,sticky="w")
foodcs=Checkbutton(root,text="Chicken Sukha\t\t₹130",variable=var39,font=" helvetica10",command=food_csukha).grid(row=19,column=0,sticky="W")
foodncs=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_39)
foodncs.grid(row=19,column=1,sticky="w")
foodms=Checkbutton(root,text="Mutton Sukha\t\t₹120",variable=var310,font=" helvetica10",command=food_msukha).grid(row=20,column=0,sticky="W")
...
foodfk=Checkbutton(root,text="Fish Koliwada\t\t₹190",variable=var311,font=" helvetica10",command=food_fkoli).grid(row=16,column=0,sticky="W")
foodnfk=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_311)
foodnfk.grid(row=16,column=1,sticky="w")
#Breads
foodchapati=Checkbutton(root,text="Chapati\t\t\t₹10",variable=var51, font="helvetica10",command=food_chapati).grid(row=11,column=2,sticky="w")
foodnchapati=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_51)
foodnchapati.grid(row=11,column=3)
foodtroti=Checkbutton(root,text="tandoori Roti\t\t₹15",variable=var52 , font="helvetica10",command=food_troti).grid(row=12,column=2,sticky="w")
foodntroti=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_52)
foodntroti.grid(row=12,column=3)
foodnaan=Checkbutton(root,text="Naan\t\t\t₹25",variable=var53, font="helvetica10",command=food_naan).grid(row=13,column=2,sticky="w")
foodnnaan=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_53)
foodnnaan.grid(row=13,column=3)
foodbnaan=Checkbutton(root,text="Butter Naan\t\t₹30",variable=var54, font="helvetica10",command=food_bnaan).grid(row=14,column=2,sticky="w")
foodnbnaan=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_54)
foodnbnaan.grid(row=14,column=3)
foodkulcha=Checkbutton(root,text="Kulcha\t\t\t₹30",variable=var55, font="helvetica10",command=food_kulcha).grid(row=15,column=2,sticky="w")
foodnkulcha=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_55)
foodnkulcha.grid(row=15,column=3)
foodbkulcha=Checkbutton(root,text="Butter Kulcha\t\t₹35",variable=var56, font="helvetica10",command=food_bkulcha).grid(row=16,column=2,sticky="w")
foodnbkulcha=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_56)
foodnbkulcha.grid(row=16,column=3)
#Rice
foodjeera=Checkbutton(root,text="\tJeera Rice\t\t₹80",variable=var61, font="helvetica10",command=food_jeera).grid(row=4,column=4,sticky="w")
foodnjeera=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_61)
foodnjeera.grid(row=4,column=5)
foodcurd=Checkbutton(root,text="\tCurd Rice\t\t₹50",variable=var62, font="helvetica10",command=food_curd).grid(row=5,column=4,sticky="w")
foodncurd=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_62)
foodncurd.grid(row=5,column=5)
foodrajma=Checkbutton(root,text="\tRajma Rice\t\t₹100",variable=var63 , font="helvetica10",command=food_rajma).grid(row=6,column=4,sticky="w")
foodnrajma=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_63)
foodnrajma.grid(row=6,column=5)
foodvegpulav=Checkbutton(root,text="\tVeg Pulav\t\t₹120",variable=var64 , font="helvetica10",command=food_vegpulav).grid(row=7,column=4,sticky="w")
foodnvpulav=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_64)
foodnvpulav.grid(row=7,column=5)
foodvegbir=Checkbutton(root,text="\tVeg Biryani\t\t₹120",variable=var65 , font="helvetica10",command=food_vegbir).grid(row=8,column=4,sticky="w")
foodnvbir=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_65)
foodnvbir.grid(row=8,column=5)
foodcbir=Checkbutton(root,text="\tChicken Biryani\t\t₹120",variable=var66, font="helvetica10",command=food_cbir).grid(row=9,column=4,sticky="w")
foodncbir=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_66)
foodncbir.grid(row=9,column=5)
foodmbir=Checkbutton(root,text="\tMutton Biryani\t\t₹150",variable=var67, font="helvetica10",command=food_mbir).grid(row=4,column=6,sticky="w")
foodnmbir=Entry(root,state=DISABLED,width=6,justify="right",textvariable=var_67)
foodnmbir.grid(row=4,column=7)
foodfish=Checkbutton(root,text="\tPrawns Rice\t\t₹160",variable=var68, font="helvetica10",command=food_fish).grid(row=5,column=6,sticky="w")
